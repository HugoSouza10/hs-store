...
async function main() {
  try {
    const mousesCategory = await db.category.create({
      data: {
        name: "Mouses",
        slug: "mouses",
        imageUrl:
    ...
    const keyboardsCategory = await db.category.create({
      data: {
        name: "Teclados",
        slug: "keyboards",
        imageUrl:
    ...
    const headphonesCategory = await db.category.create({
      data: {
        name: "Fones",
        slug: "headphones",
        imageUrl:
    ...
    const mousepadsCategory = await db.category.create({
      data: {
        name: "Mousepads",
        slug: "mousepads",
        imageUrl:
    ...
    const monitorsCategory = await db.category.create({
      data: {
        name: "Monitores",
        slug: "monitors",
        imageUrl:
    ...
    const speakersCategory = await db.category.create({
      data: {
        name: "Speakers",
        slug: "speakers",
        imageUrl:
